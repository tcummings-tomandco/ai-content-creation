...
4. **Inline citations to authoritative sources:** PASS — 5 inline external citations: BCC/Essex (x2, news page and PDF), ONS BICS ad hoc tables, McKinsey State of AI, Bain Automation and AI Pathfinder Survey 2026. All primary UK sources or named research firms with disclosed methodology. No agency blogs. At the lower end of the 5-10 target band. (ONS ASHE 2025 and the GOV.UK NI rates page support the Layer 2 calculation and are cited in sources.md and stat_bank_update.json rather than inline, consistent with stat-sourcing.md's "no inline methodology block" rule.)
